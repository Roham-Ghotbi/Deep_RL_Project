...
%% HW 5
clear all; close all;
home =  '/Users/chnajafi94/Documents/GitHub/cs285Project/cs285/GrpD-HalfCheetah';
cd(home);
...
xlabel('Iteration #');
ylabel('Actor Loss');
legend(c,'Location','SouthWest ','Interpreter','None');
...
for i = 1:length(fol_eval_avg)
    ...
    avg = movmean(avg,n); 
    std = movmean(std,n);
    errorbar(iter(1:2:end), avg(1:2:end),std(1:2:end),'linewidth',4,'Markersize',1,'CapSize',2);
end
c = {'Differential Q Learning', 'Conventional Q Learning'};
grid on;
ax = gca;
